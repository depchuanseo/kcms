...
-- Dumping data for table kcms.banners: ~3 rows (approximately)
DELETE FROM `banners`;
/*!40000 ALTER TABLE `banners` DISABLE KEYS */;
INSERT INTO `banners` (`id`, `terms`, `title`, `slug`, `image`, `description`, `published`, `params`, `created`) VALUES
	(1, 'slideshow', 'Slides Logo 1', 'slides-logo-12', 'Lighthouse.jpg', 'admins', 1, 'addmin', '2014-10-30 00:37:40'),
...
-- Dumping data for table kcms.categories: ~3 rows (approximately)
...
-- Dumping data for table kcms.links: ~4 rows (approximately)
DELETE FROM `links`;
...
-- Dumping data for table kcms.menus: ~2 rows (approximately)
DELETE FROM `menus`;
...
-- Dumping data for table kcms.posts: ~2 rows (approximately)
DELETE FROM `posts`;
/*!40000 ALTER TABLE `posts` DISABLE KEYS */;
INSERT INTO `posts` (`id`, `category_id`, `title`, `slug`, `image`, `description`, `meta_title`, `meta_keywords`, `meta_description`, `published`, `terms`, `created`, `modified`) VALUES
	(1, 13, 'Thử', 'thu', '6.jpg', '<p>thử</p>\r\n', '', '', '', 1, 'post', '2014-10-31 08:14:33', '2014-10-31 08:24:43'),
	(2, 13, 'Thử bài viết', 'thu-bai-viet', '6.jpg', '<p>Thử bài viết</p>\r\n', '', '', '', 1, 'post', '2014-10-31 08:22:50', '2014-10-31 08:22:50');
...
INSERT INTO `users` (`id`, `group_id`, `username`, `password`, `email`, `published`, `created`, `modified`) VALUES
	(1, 1, 'admin', '$2a$10$Y9HMF2abZ18V9kSHQ/jWQuj4MIbJCYSsL/0MzlpIQV8MPcfjIv/.u', 'depchuanseo@gmail.com', 1, '2014-10-28 09:32:15', '2014-10-31 07:30:59'),
