<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Category', array('type' => 'file', 'role' => 'form', 'inputDefaults' => array('class' => 'form-control', 'div' => 'form-group'))); ?>
        <fieldset>
            <legend></legend>
            <?php
            echo $this->Form->input('id');
            echo $this->Form->input('parent_id', array('options' => $categoriesTree, 'empty' => '--Chọn danh mục cha--'));
            ...
            echo $this->Form->input('template', array('options' => $optionsTemplate, 'default' => $currentTemplate));
